...
function Me() {
  ...
  return (
    <div id="me" className="sm:grid grid-cols-2 p-12 bg-[#1C3879] sm:m-20 m-5 rounded-2xl justify-center items-center drop-shadow-2xl">
      <div className="text-center">
        <Image className="" src={me} alt="" objectFit='contain' width="400" height="450" />
      </div>
