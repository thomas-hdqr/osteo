  ...
  return (
    <section id="me" className="md:grid grid-cols-2 p-12 bg-[#1C3879] m-20 rounded-2xl justify-center items-center ">
      ...
      <div className="text-[#DCD6D6] text-right">
        <h3 className="font-semibold">Qui suis-je</h3>
        ...
        <p className="pt-5 leading-10">Et consequatur consequatur sit minima enim id numquam nostrum aut quam culpa eum vitae fugit ab quos neque et sint rerum. Ut vitae voluptate aut architecto vitae 33 nostrum reprehenderit.</p>
      </div>
    </section>
  )
}
